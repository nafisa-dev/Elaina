...
Skrip ini dibuat oleh [Nafisa](https://github.com/nafisa-dev) menggunakan Node.js dan pustaka [WhiskeySocket/Baileys](https://github.com/WhiskeySockets/Baileys). Skrip ini saat ini dalam tahap pengembangan (BETA), jadi mungkin masih ada beberapa kesalahan yang dapat diabaikan. Jika kesalahan tetap ada bahkan setelah debugging, silakan hubungi pemilik untuk mendapatkan bantuan. ~ Oleh Nafisa

## Contributor

- [Nafisa](https://github.com/nafisa-dev) (Pembuat)
- [Nafisa](https://github.com/nafisa-dev) (Penyedia Layanan API)
- [Nafisa](https://github.com/nafisa-dev) (Penyumbang Code)

#### Join Group
[![Grup WhatsApp](https://img.shields.io/badge/WhatsApp%20Group-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://chat.whatsapp.com/BkNdgz74mRpKWU0ByCbhgr) 
